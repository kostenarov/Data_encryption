...
class ImportImagePageFile extends StatefulWidget {
  final File fileToEncrypt;
  final String passwordToEncrypt;
  const ImportImagePageFile(
      {Key? key, required this.fileToEncrypt, required this.passwordToEncrypt})
      : super(key: key);

  @override
  State<ImportImagePageFile> createState() => _ImportImagePageFileState();
}

class _ImportImagePageFileState extends State<ImportImagePageFile> {
  File? _image;
